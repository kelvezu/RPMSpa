...
if(isset($_POST['save'])){    
    ...
    if(isset($_POST['update'])){    
        ...
        $query = "UPDATE school_tbl SET school_id='$school_id', school_name='$school_name', tel_no='$tel_no', reg_id='$reg_id', div_id='$div_id', muni_id='$muni_id' WHERE school_id='$school_id'";
        $query_run = mysqli_query($conn,$query);
