...
if (isset($_POST['updatetOBJ'])) {
    ...
    if ((ctype_space($tobj_name))) {
        ...
        $update_res = mysqli_query($conn, "UPDATE tobj_tbl SET tobj_id = '$tobj_id', kra_id = '$kraid', tobj_name = '$tobj_name' classroom_observable = '$classroom_observable', indicator_id = '$map_indicator' WHERE tobj_id = '$tobj_id' ");
...
if (isset($_POST['addobj'])) {
    ...
    if ($count_result > 0) {
        ...
        $query = "INSERT INTO tobj_tbl(kra_id,tobj_name,classroom_observable,indicator_id,date_created) VALUES('$select_kra','$addobjname','$class_observable','$map_indicator','" . datenow() . "')";
