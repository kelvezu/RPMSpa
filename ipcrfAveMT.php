...
<div class="container">
    ...
    <div class="bg-dark h4 text-white breadcrumb">Master Teacher IPCRF Rating</div>
    <div class="px-3">
       
    
        <form action="ipcrf_mt_chart.php" method="POST" class="form-inline">
...
<script>
    ...
    function showAve() {
        ...
        let school = document.getElementById('school_id').value;
        ...
        if ((sy_id == "")) {
            ...
            xmlhttp.open("GET", "ipcrfAveMTAjax.php?sy=" + sy_id + "&user=" + user  + "&pos=" + position + "&sch=" + school + "&rater=" + rater, true);
            xmlhttp.send();
        }
    }
