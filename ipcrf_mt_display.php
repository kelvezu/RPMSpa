    ...
    <div class="card">
        <div class="card-header">
            <div class="d-flex justify-content-between">
                ...
                <div class="p-2">
                    <span class="font-weight-bold">Name of Employee: </span><?php echo displayname($conn, $rater); ?><br>
                    <span class="font-weight-bold">Position: </span><?php echo getPosition($conn, $rater) ?><br>
