...
<div class="container-fluid">
    <h4 class="text-center bg-dark text-white p-3">INDIVIDUAL PERFORMANCE COMMITMENT AND REVIEW FORM – Teacher I-III (Proficient Teachers)</h4>

    <a href="ipcrf_t_total_rating_pdf.php" class="btn btn-primary m-3"><i class="fa fa-file-pdf"></i> Save as PDF</a>
        ...
        <thead class=" bg-dark text-white text-center ">
            ...
            <tr>
                ...
                foreach ($kra_tbl as $kra) :
                    $kra_id = $kra['kra_id']; ?>
                    <th colspan="<?php echo $ipcrf->countKRAobjective($kra_id, 'tobj_tbl') ?>">
                        <p> KRA: <?= $kra_id ?> </p>
                    </th>
                <?php endforeach; ?>
                ...
                foreach ($ipcrf_user as $user) :
                    ...
                    <tr>
                        ...
                        <?php if ($user_position) : ?>
                            ...
                            <td>
                                <p> <?php echo $ipcrf->fetch_user_Score($ipcrf_tbl, $obj['tobj_id'], $users) ?></p>
                            <?php else : ?>
                            <td>
                                <p> --- </p>
                        <?php endif;
