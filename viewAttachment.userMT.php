                    ...
                    <?php foreach ($KRAandOBJ as $kra) : ?>
                        <tr>
                            ...
                            <td class="text-justify">
                                <?php
                                    $main_mov =  showMainAttachmentMT($conn, $kra['mtobj_id'], $_SESSION['user_id'], $_SESSION['school_id'], $_SESSION['active_sy_id'], $kra['kra_id']);
                                    // pre_r($main_mov);
                                    ...
                                    <button data-toggle="modal" data-target="#updateModal<?= $mmov['mov_id'] . $kra['mtobj_id'] ?>" class="btn btn-outline-primary btn-sm m-1">
                                        <?= $mmov['file_name'] ?>
                                        <a href="includes/processattachuser.php?&attach_mov_id=<?= showAttachmentIDMT($conn, $mmov['sy_id'], $mmov['school_id'], $mmov['mov_id'], $kra['mtobj_id'], $mmov['mov_type'], $kra['kra_id'])  ?>" class="fa fa-times text-danger"></a>
                                    </button>
