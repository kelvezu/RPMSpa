                ...
                <div class="modal-body">
                        ...
                        <div class="form-group row">   
                            ...
                            <div class="col-sm">
                                ...
                                <input type="number" name ="school_no" id ="school-no" class="form-control" placeholder="Enter the School No...">
                            </div>
                            </div>
                            <div class="form-group row">   
                            <div class="col-sm">
                                <label for="school-name" class="col-form-label"><strong>School Name</strong></label>
                                <input type="text" name ="school_name" id="school-name" class="form-control" placeholder="Enter the School Name...">
                            </div>
                            </div>
                            ...
                            <div class="col-sm">
                                ...
                                <input type="number" name ="tel_no" id ="tel-no" class="form-control" placeholder="Enter the Telephone Number...">
                            </div>
                            </div>
                            <div class="form-group row">   
                            <div class="col-sm">
