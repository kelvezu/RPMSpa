...
<div class="container">
    ...
    <div class="col-sm my-4">
        ...
        <div class="col-sm my-4">
            <h5> Gender Option</h5>
            <?php 
                $genderjqry = "SELECT * FROM gender_tbl";
        ...
        <div class="col-sm my-4">
            ...
            <?php 
                $posiqry = "SELECT * FROM position_tbl WHERE position_id IN (3,4,5,6,7,8,9)";
    ...
    <div class="col-sm my-4">
            ...
            <?php 
                $totyrqry = "SELECT * FROM totalyear_tbl";
  ...
  <td><strike><?php echo $row['totalyear_name'] ?></strike></td>
        ...
        <div class="col-sm my-4">
            ...
            <?php 
                $gltqry = "SELECT * FROM gradelvltaught_tbl";
      ...
      <!-- Start of Row 4-->
        ...
        <div class="col-sm my-4">
            <h5>Curricular Classification of the School Option</h5>
                <?php 
                $curriqry = "SELECT * FROM curriclass_tbl";
