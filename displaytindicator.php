                ...
                <div class="modal-body">
                        <form action="includes/processtindicator.php" method="POST">  
                            ...
                            <div class="col-lg">
                                    ...
                                    <input type="number" name="indicator_no" id="indicator_no" class="form-control" width="500" placeholder="Enter the Indicator Number..."> 
                            </div>
                            </div>
                            <div class="row">
                            <div class="col-lg">
...
<textarea class="form-control" name="ioaf_comment" rows="5" placeholder="OTHER COMMENTS"></textarea>
</div>
</div>
</div>
</div>
