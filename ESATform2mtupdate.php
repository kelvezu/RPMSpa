  ...
  <div class="card">
    ...
    <div class="table">
          ...
          <tbody class="text-dark">
            <tr>
              ...
              <?php
                ...
                <?php
                $objective_Query = $conn->query("SELECT * FROM esat2_objectivesmt_tbl WHERE kra_id = '$kra_id' AND mtobj_id = '$mtobj_id' AND `user_id` = '$user_id' ");
      ...
      <div class="card-footer text-muted ">
        ...
        <button type="submit" class="btn btn-success" name="updateESAT2mt">Update</button>
