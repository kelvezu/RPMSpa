...
$num = 1;
 ...
 //$ipcrf_details = $ipcrf->fetchIPCRFGenT('ipcrf_t');
 $ipcrf_details = IPCRF::fetchIPCRFGenMT($conn,$sy_id);
 $ipcrf_final_details = IPCRF::fetchIPCRFGenFinalMT($conn,$sy_id);
...
/* <p><?php echo displayName($conn, $user); ?></p>*/
 ...
 $ipcrf_array = [];
 $IPCRFqry = mysqli_query($conn, "SELECT * FROM ipcrf_mt  WHERE sy_id = $sy_id AND school_id = $school_id") or die($conn->error);
                        ...
                        <?php if ($ipcrf_details) : foreach ($ipcrf_details as $details) : ?>
                                ...
                                <td>
                                    <p class="text-justify font-italic">
                                        <?php echo IPCRF::displayPerfIndicatorGenMT($conn,$details['actual_result_quality']) ?>
                                    </p>
                                </td>
                                ...
                                <td>
                                    <p class="text-justify font-italic">
                                        <?php echo IPCRF::displayPerfIndicatorGenMT($conn,$details['actual_result_efficiency']) ?>
                                    </p>
                                </td>
                                ...
                                <td>
                                    <p class="text-justify font-italic">
                                        <?php echo IPCRF::displayPerfIndicatorGenMT($conn, $details['kra_id'], $details['obj_id'], $details['timeliness']) ?>
                                    </p>
                                </td>
