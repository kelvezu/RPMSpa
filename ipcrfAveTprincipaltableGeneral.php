...
<div class="container">
    ...
    <div class="d-flex justify-content-center my-2">
        <h5><strong>IPCRF-RPMS for Teacher I-III</strong></h5>
    </div>
    ...
    <div class="card">
        ...
        <div class="card-body">
            <table class="table table-sm table-responsive-sm table-bordered">
                ...
                <tbody>
                    <tr>
                        <?php if (IPCRF::fetchIPCRFGenTP($conn,$sy_id,$school_id)) : foreach ($ipcrf_details = IPCRF::fetchIPCRFGenTP($conn,$sy_id,$school_id) as $details) : ?>
                                <!-- number -->
                                <td>
                                    <p>
                                        <?php echo $num++ ?>
                                ...
                                <td>
                                    <p class="text-justify font-italic">
                                        <?php echo IPCRF::displayPerfIndicatorGenTP($conn, $details['actual_result_quality']) ?>
                                    </p>
                                </td>
                                ...
                                <td>
                                    <p class="text-justify font-italic">
                                        <?php echo IPCRF::displayPerfIndicatorGenTP($conn, $details['actual_result_efficiency']) ?>
                                    </p>
                                </td>
                                ...
                                <td>
                                    <p class="text-justify font-italic">
                                        <?php echo IPCRF::displayPerfIndicatorGenTP($conn, $details['kra_id'], $details['obj_id'], $details['timeliness']) ?>
                                    </p>
                                </td>
