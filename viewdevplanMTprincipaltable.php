                    ...
                    <div class="body">
                        <div class="row p-2">
                            <div class="col form-group">
                                ...
                                <ul>
                                    <?php 
                                    $strQry = $conn->query("SELECT * FROM devplanmt_a1_strength_tbl WHERE `user_id` = '$user' AND sy = '$sy' ");
                                         foreach ($strQry as $str_obj) :
                                             ?>           
                                        
                                        <p class="black-border"> <?php echo displayObjectiveMT($conn, $str_obj['strengths_mtobj']); ?></p>
                            ...
                            <div class="col form-group">
                                 <?php 
                                    $strQry = $conn->query("SELECT * FROM devplanmt_a2_devneeds_tbl WHERE `user_id` = '$user' AND sy = '$sy' ");
                                         foreach ($strQry as $str_obj) :
                                             ?>    
                                  
                                       <p class="black-border"> <?php echo displayObjectiveMT($conn, $str_obj['devneeds_mtobj']); ?></p>
                        ...
                        <?php 
                                    $strQry = $conn->query("SELECT * FROM devplanmt_a3_actionplan_tbl WHERE `user_id` = '$user' AND sy = '$sy' ");
                                         foreach ($strQry as $str_obj) :
                                             ?>    
                    ...
                    <div class="body">
                        <div class="row p-2">
                            <div class="col form-group">
                                ...
                                <ul>
                                    <?php 
                                    $strQry = $conn->query("SELECT * FROM devplanmt_b1_strength_tbl WHERE `user_id` = '$user' AND sy = '$sy' ");
                                         foreach ($strQry as $str_obj) :
                                             ?>           
                                        
                                        <p class="black-border"> <?php echo displayObjectiveMT($conn, $str_obj['strength_cbc_id']); ?></p>
                            ...
                            <div class="col form-group">
                                ...
                                <ul>
                                    <?php 
                                    $strQry = $conn->query("SELECT * FROM devplanmt_b2_devneeds_tbl WHERE `user_id` = '$user' AND sy = '$sy' ");
                                         foreach ($strQry as $str_obj) :
                                             ?>           
                                        
                                        <p class="black-border"> <?php echo displayObjectiveMT($conn, $str_obj['devneed_cbc_id']); ?></p>
                        ...
                        <div class="bg-dark text-white">
                         ...
                         <?php 
                                    $strQry = $conn->query("SELECT * FROM devplanmt_b3_actionplan_tbl WHERE `user_id` = '$user' AND sy = '$sy' ");
                                         foreach ($strQry as $str_obj) :
                                             ?>    
                        <div class="row p-2">
                            <div class="col form-group">
