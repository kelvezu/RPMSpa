        ...
        <script type="text/javascript">
            ...
            function GenderChart() {
                let data = google.visualization.arrayToDataTable([
                    ...
                    <?php
                            $qry = $conn->query("SELECT esat1_demographicsmt_tbl.gender, COUNT(esat1_demographicsmt_tbl.user_id) total FROM esat1_demographicsmt_tbl WHERE sy = '$sy' AND school = '$school' GROUP BY esat1_demographicsmt_tbl.gender") or die($conn->error);
...
CASE WHEN sy = ('" . $_SESSION['active_sy_id'] . "')-1 THEN COUNT(`user_id`) END AS sy2, 
CASE WHEN sy = ('" . $_SESSION['active_sy_id'] . "')-2 THEN COUNT(`user_id`) END AS sy3  
FROM esat1_demographicsmt_tbl WHERE gender = '" . $genderdemo['gender_name'] . "'  AND sy = '$sy' AND school = '$school' group by sy") or die($conn->error);
...
CASE WHEN sy = ('" . $_SESSION['active_sy_id'] . "')-1 THEN COUNT(`user_id`) END AS sy2, 
CASE WHEN sy = ('" . $_SESSION['active_sy_id'] . "')-2 THEN COUNT(`user_id`) END AS sy3  
FROM esat1_demographicsmt_tbl WHERE employment_status = '" . $employdemo['emp_status'] . "'  AND sy = '$sy' AND school = '$school' group by sy") or die($conn->error);
...
CASE WHEN sy = ('" . $_SESSION['active_sy_id'] . "')-1 THEN COUNT(`user_id`) END AS sy2, 
CASE WHEN sy = ('" . $_SESSION['active_sy_id'] . "')-2 THEN COUNT(`user_id`) END AS sy3  
FROM esat1_demographicsmt_tbl WHERE position = '" . $positiondemo['position_name'] . "'  AND sy = '$sy' AND school = '$school' group by sy") or die($conn->error);
                                while ($PositionQry = $qry->fetch_assoc()) :
...
CASE WHEN sy = ('" . $_SESSION['active_sy_id'] . "')-1 THEN COUNT(`user_id`) END AS sy2, 
CASE WHEN sy = ('" . $_SESSION['active_sy_id'] . "')-2 THEN COUNT(`user_id`) END AS sy3  
FROM esat1_demographicsmt_tbl WHERE highest_degree = '" . $highestdegreedemo['degree_name'] . "'  AND sy = '$sy' AND school = '$school' group by sy") or die($conn->error);
...
CASE WHEN sy = ('" . $_SESSION['active_sy_id'] . "')-1 THEN COUNT(`user_id`) END AS sy2, 
CASE WHEN sy = ('" . $_SESSION['active_sy_id'] . "')-2 THEN COUNT(`user_id`) END AS sy3  
FROM esat1_demographicsmt_tbl WHERE totalyear = " . $totalyeardemo['totalyear_id'] . "  AND sy = '$sy' AND school = '$school' group by sy") or die($conn->error);
...
CASE WHEN sy = ('" . $_SESSION['active_sy_id'] . "')-1 THEN COUNT(`user_id`) END AS sy2, 
CASE WHEN sy = ('" . $_SESSION['active_sy_id'] . "')-2 THEN COUNT(`user_id`) END AS sy3  
FROM esat1_demographicsmt_tbl INNER JOIN subject_tbl ON esat1_demographicsmt_tbl.subject_taught LIKE CONCAT('%', subject_tbl.subject_name, '%') WHERE sy = '$sy' AND school = '$school' GROUP BY subject_tbl.subject_name") or die($conn->error);
...
CASE WHEN sy = ('" . $_SESSION['active_sy_id'] . "')-1 THEN COUNT(`user_id`) END AS sy2, 
CASE WHEN sy = ('" . $_SESSION['active_sy_id'] . "')-2 THEN COUNT(`user_id`) END AS sy3  
FROM gradelvltaught_tbl INNER JOIN esat1_demographicsmt_tbl ON esat1_demographicsmt_tbl.grade_lvl_taught LIKE CONCAT('%', gradelvltaught_tbl.gradelvltaught_id, '%') WHERE sy = '$sy' AND school = '$school' GROUP BY gradelvltaught_tbl.gradelvltaught_name") or die($conn->error);
...
CASE WHEN sy = ('" . $_SESSION['active_sy_id'] . "')-1 THEN COUNT(`user_id`) END AS sy2, 
CASE WHEN sy = ('" . $_SESSION['active_sy_id'] . "')-2 THEN COUNT(`user_id`) END AS sy3  
FROM esat1_demographicsmt_tbl WHERE curri_class = " . $curridemo['curriclass_id'] . "  AND sy = '$sy' AND school = '$school' group by sy") or die($conn->error);
...
CASE WHEN sy = ('" . $_SESSION['active_sy_id'] . "')-1 THEN COUNT(`user_id`) END AS sy2, 
CASE WHEN sy = ('" . $_SESSION['active_sy_id'] . "')-2 THEN COUNT(`user_id`) END AS sy3  
FROM esat1_demographicsmt_tbl WHERE region = " . $regiondemo['reg_id'] . "  AND sy = '$sy' AND school = '$school' group by sy") or die($conn->error);
