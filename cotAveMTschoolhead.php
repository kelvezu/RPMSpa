...
<script>
    ...
    function showAve() {
        ...
        if ((sy_id == "" || teacher_id == "")) {
            ...
            xmlhttp.open("GET", "cotAveMTprincipaltableGeneral.php?sy=" + active_sy_id + "&sch=" + school_id, true);
            xmlhttp.send();
            return;
        } else {
            let xmlhttp = new XMLHttpRequest();
            ...
            xmlhttp.open("GET", "cotAveMTprincipaltable.php?sy=" + sy_id + "&user=" + teacher_id + "&sch=" + school_id, true);
            xmlhttp.send();
            return;
        }
    }
