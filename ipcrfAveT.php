...
<div class="container">
    ...
    <div class="bg-dark h4 text-white breadcrumb">Teacher IPCRF Rating</div>
    <div class="px-3">
       
    
        <form action="ipcrf_t_chart.php" method="POST" class="form-inline">
...
<script>
    ...
    function showAve() {
        ...
        if ((sy_id == "")) {
            ...
            xmlhttp.open("GET", "ipcrfAveTAjax.php?sy=" + sy_id + "&user=" + user  + "&pos=" + position + "&sch=" + school + "&rater=" + rater, true);
            xmlhttp.send();
        }
    }
