...
$objective_table = 'esat2_objectivest_tbl';
    ...
    <div id="myModal" class="modal container-fluid" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <form action="includes/processdevplan_t.php" method="post">
                                    ...
                                    <td>
                                        <ul>
                                            ...
                                            ?>
                                                    ...
                                                    <li><?= displayObjectiveT($conn, $strobj); ?></li>
                                            <?php endforeach;
                                    ...
                                    <td>
                                        <ul>
                                            ...
                                            <?php if ($obj_devneed) : foreach ($obj_devneed as $devneedobj) : ?>
                                                    ...
                                                    <li><?= displayObjectiveT($conn, $devneedobj); ?></li>
                                            <?php endforeach;
                                            else : echo "<p class='text-center'>---</p>";
                                            endif; ?>
                                        </ul>
    ...
    <form method="post">
        <div class="card border-dark">
            <div class="card-header  bg-success text-white font-weight-bold">
                <h3>Create Development Plan for Teacher I-III</h3>
                                ...
                                <ul>
                                    ...
                                    <?php if ($strength_objective) : foreach ($strength_objective as $str_obj) :
                                            ...
                                            <li class="black-border mb-1">
                                                ...
                                                Objective: <span class=" text-justify font-italic font-weight-normal"><?= displayObjectiveT($conn, $obj) ?></span>
                                            </li>
                                    <?php endforeach;
                                    else : echo "<p class='text-center'>---</p>";
                                    endif; ?>
            ...
            <div class="card-footer">
                <div class="d-flex justify-content-center">
                    <div class="p-3"><button name="create_dp_t" class="font-weight-bold btn btn-success">Submit</button></div>
