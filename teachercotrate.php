...
<div id="confirmRate" class="modal fade bd-example-modal-xl" tabindex="-1" role="dialog" aria-labelledby="myExtraLargeModalLabel" aria-hidden="true">
        ...
        if($period_result == $period):
            ...
            <form action="teachercotrateform.php" id="form" method="POST">
...
<div id="confirmRateMT" class="modal fade bd-example-modal-xl" tabindex="-1" role="dialog" aria-labelledby="myExtraLargeModalLabel" aria-hidden="true">
        ...
        if($period_resultMT == $period):
            ...
            <form action="teachercotrateformMT.php" id="form" method="POST">
            <label><strong>Enter Principal Password:</strong></label>
            <input type="hidden" name="school_id" value="<?php echo $_SESSION['school_id']; ?>">
            <input type="password" name="pass">
            <input type="submit" value="Go" class="btn btn-primary" name="password_sub">
...
<div class="container-fluid">
    <div class="d-flex justify-content-center">
        <div class="p-2">
            <h2>Class Observation Status of Teachers I Rate</h2>
        </div>
    </div>
                        ...
                        <tr>
                            ...
                            <td><?= $t_res['position'] ?></td>
                             <td><?= RPMSdb::TcheckResult_Obs1($conn, $t_res['user_id'], $_SESSION['active_sy_id'], $_SESSION['school_id']) ?
                                        '<a href="displaytcotprogress.php?user_id='.$t_res["user_id"].'&obs=1"><i class="fa fa-check-circle text-success"></i></a>' : '<a href="teachercotrate.php?ratecot=1"><i class="fa fa-times-circle text-danger"></i></a>'; ?></td>
                                    <td><?= RPMSdb::TcheckResult_Obs2($conn, $t_res['user_id'], $_SESSION['active_sy_id'], $_SESSION['school_id']) ?
                                        '<a href="displaytcotprogress.php?user_id='.$t_res["user_id"].'&obs=2"><i class="fa fa-check-circle text-success"></i></a>'  : '<a href="teachercotrate.php?ratecot=2"><i class="fa fa-times-circle text-danger"></i></a>'; ?></td>
                                    <td><?= RPMSdb::TcheckResult_Obs3($conn, $t_res['user_id'], $_SESSION['active_sy_id'], $_SESSION['school_id']) ?
                                        '<a href="displaytcotprogress.php?user_id='.$t_res["user_id"].'&obs=3"><i class="fa fa-check-circle text-success"></i></a>'  : '<a href="teachercotrate.php?ratecot=3"><i class="fa fa-times-circle text-danger"></i></a>'; ?></td>
                                    <td><?= RPMSdb::TcheckResult_Obs4($conn, $t_res['user_id'], $_SESSION['active_sy_id'], $_SESSION['school_id']) ?
                                        '<a href="displaytcotprogress.php?user_id='.$t_res["user_id"].'&obs=4"><i class="fa fa-check-circle text-success"></i></a>'  : '<a href="teachercotrate.php?ratecot=4"><i class="fa fa-times-circle text-danger"></i></a>'; ?></td>
                            <td><?php
                                    if (
