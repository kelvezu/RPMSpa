        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="includes/processtkramov.php" method="POST">
                    <!-- <div class="form-group row"> -->
                    <div class="col">
                        <label for="add-cbc">Select Key Result Areas</label>
                        <select name="select_kra" id="" class="form-control" required>
                            <option value="" disabled selected>---Select Key Result Area---</option>
                            <?php
                    ...
                    <!-- </div> -->
                    <div class="col">
                        <label for="addobjname">Enter the Objective</label>
                        ...
                        <label for="classroom_observable">Is this class observable?</label>
                        <select name="classroom_observable" id="classroom_observable" class="form-control" required>
                        ...
                        <div id="map_indicator_group">
                            <label for="map_indicator">Select an Indicator to mapped this Objective</label>
                            <select name="map_indicator" id="map_indicator" class="form-control">
                                <option selected>--Select--</option>
                                <?php foreach (fetchTindicator($conn) as $indicator) : ?>
                                    <option class="text-wrap" value="<?= $indicator['tindicator_id'] ?>">
...
<script>
    const class_obs = document.getElementById("classroom_observable");
    const map_group = document.getElementById("map_indicator_group");
    const map_indicator = document.getElementById("map_indicator");
    map_group.style.display = "none";

    class_obs.addEventListener("click", popMap);

    function popMap() {
        // console.log(class_obs.value);
        if (class_obs.value == "Yes") {
