                ...
                <div class="modal-body">
                        <form action="includes/processpolicy.php" method="POST">  
                            ...
                            <div class="col-lg">
                                    ...
                                    <input type="text" name="policytitle" id=policy-title" class="form-control" width="500"  placeholder="Enter the Policy Title..."/> 
                            </div>
                            </div>
                            <div>
                                    <label for="content" class="control-label w-25 "><strong>Policy Content</strong></label>
                                    <textarea name="policycontent" id="policy-content" cols="5" rows="5" class="form-control" value="" placeholder="Enter the Policy Content..."></textarea>
                            </div>  
                            <div class="m-2">
