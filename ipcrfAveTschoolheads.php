...
<div class="container col-md-9">
    ...
    <div class="px-3">
        ...
        <form action="ipcrfchartTschoolheads.php" method="POST" class="form-inline">
            ...
            <div class="form-row">
                ...
                <div class="form-group mb-2">
                    ...
                    <?php $teacherqry = $conn->query('SELECT * FROM account_tbl WHERE position IN ("Teacher III","Teacher II","Teacher I") AND `status` = "Active" AND school_id = "' . $_SESSION['school_id'] . '"') or die($conn->error); ?>
...
<script>
    ...
    function showAve() {
        ...
        if ((sy_id == "" || teacher_id == "")) {
            ...
            xmlhttp.open("GET", "ipcrfAveTschoolheadstableGeneral.php?sy=" + active_sy_id + "&sch=" + school_id, true);
            xmlhttp.send();
            return;
        } else {
            let xmlhttp = new XMLHttpRequest();
            ...
            xmlhttp.open("GET", "ipcrfAveTschoolheadstable.php?sy=" + sy_id + "&user=" + teacher_id + "&sch=" + school_id, true);
            xmlhttp.send();
            return;
        }
    }
