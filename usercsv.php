                           ...
                           if(columns.length == 9){
                            ...
                            /*------------------Validation for PRC ID---------------------------*/
                               if(columns[0]){
                                    ...
                                    if(!columns[0].match(/^[0-9]+$/)){columns[0] = "<p class='text-danger'>PRC id must be numbers</p>";    isError = true; }
                                        //     THIS FUNCTION WILL DETECT IF THERE ARE DUPLICATES IN PRC
                                    if(find(columns[0])){ console.log('there is duplicate '+columns[0]); columns[0] = '<p class="text-danger">Duplicate PRC detected!</p>'; isError = true; }
                               }
                               else{columns[0] ="<p class='text-danger'>PRC id is required</p>"; isError = true;}
                               /* ----------------------------------------------------------------------------*/
                            ...
                            if(columns[1]){
                                // THIS CONDITION WILL DETECT IF THERE ARE SPECIAL CHARS IN SURNAME
                                    if(!columns[1].match(/^[A-Za-z ]+$/)){columns[1] = "<p class='text-danger'>Surname must consist of Letters</p>"; isError = true;}
                                // THIS WILL DETECT IF SURNAME IS LESS THAN 2 
                                    if(columns[1].length < 2){columns[1] = "<p class='text-danger'>Surname must be 2 or more letters</p>"; isError = true;}
                                    
                               }else{columns[1] ="<p class='text-danger'>Surname is required</p>"; isError = true;}
                            /* ----------------------------------------------------------------------------*/
                            ...
                            if(columns[2]){
                                // THIS CONDITION WILL DETECT IF THERE ARE SPECIAL CHARS IN FIRSTNAME
                                    if(!columns[2].match(/^[A-Za-z ]+$/)){columns[2] = "<p class='text-danger'>Firstname must consist of Letters</p>"; isError = true;}
                                // THIS WILL DETECT IF FIRSTNAME IS LESS THAN 2     
                                    if(columns[2].length < 2){columns[2] = "<p class='text-danger'>Firstname must be 2 or more letters</p>"; isError = true;}
                                    
                            }else{columns[2] ="<p class='text-danger'>Firstname is required</p>"; isError = true;}
                               /* ----------------------------------------------------------------------------*/

                               /*------------------Validation for Middlename---------------------------*/
                            if(columns[3]){
                                 // THIS CONDITION WILL DETECT IF THERE ARE SPECIAL CHARS IN MIDDLENAME
                                    if(!columns[3].match(/^[A-Za-z ]+$/)){columns[3] = "<p class='text-danger'>Middlename must consist of Letters</p>"; isError = true;}
                                 // THIS WILL DETECT IF MIDDLENAME IS LESS THAN 2 
                                    if(columns[3].length < 3){columns[3] = "<p class='text-danger'>Middlename must be 3 or more letters</p>"; isError = true;}
                                    
                               }else{columns[3] ="<p class='text-danger'>Middlename is required</p>"; isError = true;}
                                /* ----------------------------------------------------------------------------*/

                               /*------------------Validation for Position---------------------------*/
                            if(columns[4]){
                                // THIS CONDITION WILL DETECT IF THERE ARE SPECIAL CHARS IN POSITION
                                    if(!columns[4].match(/^[A-Za-z ]+$/)){columns[4] = "<p class='text-danger'>Position must consist of Letters</p>"; isError = true;}
                                // THIS CONDITION WILL CHECK IF THE POSITION IS LESS THAN 4
                                    if(columns[4].length < 4){columns[4] = "<p class='text-danger'>Position undefined</p>"; isError = true;}
                                // THIS POSITION WILL CHECKED IF POSITIONS ARE VALID 
                                    if(columns[4] =='Master Teacher IV' || columns[4] =='Master Teacher III' || columns[4] =='Master Teacher II' || columns[4] =='Master Teacher I' || columns[4] =='Teacher III' || columns[4] =='Teacher II' || columns[4] =='Teacher I' || columns[4] =='School Head'){
                                        true;
                                    }else{columns[4] = "<p class='text-danger'>Invalid Position</p>";  isError = true;}
                               }else{columns[4] ="<p class='text-danger'>Position is required</p>";  isError = true;}
                               /* ----------------------------------------------------------------------------*/
                            ...
                            /*------------------Validation for Email---------------------------*/
                               if(columns[5]){
                                //    THIS CONDITION WILL CHECK THE FORMAT OF EMAIL
                                   ...
                                   if(!columns[5].match(mailFormat)){columns[5] = "<p class='text-danger'>Invalid Email</p>"; isError = true;}
                                //    THIS CONDITION WILL CHECK IF THERE ARE DUPLICATE EMAIL
                                   if(find(columns[5])){ console.log('there is duplicate '+columns[5]); columns[5] = "<p class='text-danger'>Duplicate Email detected!</p>";  isError = true;}
                               }else{columns[5] = "<p class='text-danger'>Email is required.</p>";  isError = true;}
                               /* ----------------------------------------------------------------------------*/
                            ...
                            if(columns[6]){
                                ...
                                if(!columns[6].match(/^[0-9]+$/)){  columns[6] = "<p class='text-danger'>Contact must be digits</p>";  isError = true;}
                                // THIS CONDITION WILL CHECK IF THE CONTACT LENGTH IS CORRECT
                                if(columns[6].length == 10){columns[6] = `+63${columns[6]}`;  }
                                else{ columns[6] = "<p class='text-danger'>Invalid Contact Number</p>"; isError = true;}
                                // THIS CONDITION WILL CHECK IF THERE IS DUPLICATE
                                if(find(columns[6])){ console.log('there is duplicate '+columns[6]); columns[6] = "<p class='text-danger'>Duplicate Contact detected!</p>"; isError = true; }
                                
     
                               }else{columns[6] = "<p class='text-danger'>Contact number is required.</p>";  isError = true;}
                                /* ----------------------------------------------------------------------------*/
                                ...
                                if(columns[7]){
                                    ...
                                    if((columns[7] == "Male") || (columns[7] == "Female")  ){
                                       true
                                        ...
                                        columns[7] = "<p class='text-danger'>N/A</p>";  isError = true;
                                    }

                                }else{
                                    columns[7] = "<p class='text-danger'>Gender is required</p>";  isError = true;
                                }
