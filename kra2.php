                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-5" >
                            ...
                            <div class="dashone-adminprowrap shadow-reset mg-b-30">
                                ...
                                <div class="dashone-adminprowrap shadow-reset mg-b-30">
                                    <h5><b>Objective 4</b> <br>  Managed classroom structure to engage learners, individually or in groups, in meaningful exploration, discovery and hands-on activities within a range of physical learning environments.</h5>
                            ...
                            <h6>MOV Attachment Progress &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <a href="#">View Attachments</a></h6>
                                ...
                                <div class="dashone-adminprowrap shadow-reset mg-b-30">
                                    <h5><b>Objective 5 </b><br> Managed learner behavior constructively by applying positive and non-violent discipline to ensure learning-focused environments.</h5>
                                        <div class="analysis-progrebar-content">
                            ...
                            <h6>MOV Attachment Progress &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <a href="#">View Attachments</a></h6>
                                ...
                                <div class="dashone-adminprowrap shadow-reset mg-b-30">
                                    <h5><b>Objective 6 </b><br>  Used differentiated, developmentally appropriate learning experiences to address learners’ gender, needs, strengths, interests and experiences.</h5>
                                        <div class="analysis-progrebar-content">
                                        <h5><span class="counter">50</span>%</h5>
                                                    <div class="progress progress-mini">
                                                        <div style="width: 50%;" class="progress-bar">          
