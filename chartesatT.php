...
function GenderChart() {
    let data = google.visualization.arrayToDataTable([
        ...
        <?php
        $qry = $conn->query("SELECT gender_tbl.gender_name, COUNT(esat1_demographicst_tbl.user_id) total FROM esat1_demographicst_tbl INNER JOIN gender_tbl on esat1_demographicst_tbl.gender = gender_tbl.gender_id WHERE sy = '$sy' AND school = '$school' GROUP BY gender_tbl.gender_name") or die ($conn->error);
