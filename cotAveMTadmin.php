...
<div class="container col-md-9">
    ...
    <div class="bg-dark h4 text-white breadcrumb">Master Teacher COT Average</div>
    <div class="px-3">


        <form action="cotchartMTadmin.php" method="POST" class="form-inline">
            ...
            <div class="form-row">
                <div class="form-group mb-2">
                    ...
                    <?php $schoolyr = $conn->query("SELECT * FROM sy_tbl") or die($conn->error . 'schoolyr'); ?>
                ...
                <div class="form-group mb-2">
                    ...
                    <?php $schoolQry = $conn->query('SELECT * FROM school_tbl WHERE `status` = "Active"') or die($conn->error . $schoolQry); ?>
...
<script>
    ...
    function showAve() {
        ...
        if ((sy_id == "" || school_id == "")) {
            ...
            xmlhttp.open("GET", "cotAveMTadmintableGeneral.php?sy=" + active_sy_id, true);
            xmlhttp.send();
            return;
        } else {
            let xmlhttp = new XMLHttpRequest();
            ...
            xmlhttp.open("GET", "cotAveMTadmintable.php?sy=" + sy_id + "&sch=" + school_id, true);
            xmlhttp.send();
            return;
        }
    }
