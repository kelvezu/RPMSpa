                ...
                <div class="modal-body">
                        <form action="includes/processmtindicator.php" method="POST">  
                            ...
                            <div class="col-lg">
                                    ...
                                    <input type="number" name="mtindicator_no" id="mtindicator_no" class="form-control" width="500" placeholder="Enter the Indicator Number..."> 
                                </div>
                                </div>
                                <div class="row">
                                <div class="col-lg">
                                <label for="mtindicator_name" class="control-label w-25 "><strong>Indicator Name</strong></label>
                            <textarea name="mtindicator_name" id="mtindicator-name" cols="5" rows="5" class="form-control" placeholder="Enter the indicator name..."></textarea>
