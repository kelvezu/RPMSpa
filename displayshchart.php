...
<?php
		...
		$query = "SELECT CONCAT(a.kra_id,'.',a.tobj_id,' ',a.tobj_name) 
				...
				CASE WHEN b.lvlcap = 1 then count(b.priodev) END AS P_LOW,
				CASE WHEN b.lvlcap = 2 then count(b.priodev) END AS P_MODERATE,
				CASE WHEN b.lvlcap = 3 then count(b.priodev) END AS P_HIGH,
				CASE WHEN b.lvlcap = 4 then count(b.priodev) END AS P_VERY_HIGH
