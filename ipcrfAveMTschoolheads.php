...
<div class="container col-md-9">
    ...
    <div class="bg-dark h4 text-white breadcrumb">Master Teacher IPCRF Average</div>
    <div class="px-3">


        <form action="ipcrfchartMTschoolheads.php" method="POST" class="form-inline">
            ...
            <div class="form-row">
                ...
                <div class="form-group mb-2">
                    ...
                    <?php $teacherqry = $conn->query('SELECT * FROM account_tbl WHERE position IN ("Master Teacher I","Master Teacher II","Master Teacher III","Master Teacher IV") AND `status` = "Active" AND school_id = "' . $_SESSION['school_id'] . '"') or die($conn->error); ?>
...
<script>
    ...
    function showAve() {
        ...
        if ((sy_id == "" || teacher_id == "")) {
            ...
            xmlhttp.open("GET", "ipcrfAveMTschoolheadstableGeneral.php?sy=" + active_sy_id + "&sch=" + school_id, true);
            xmlhttp.send();
            return;
        } else {
            let xmlhttp = new XMLHttpRequest();
            ...
            xmlhttp.open("GET", "ipcrfAveMTschoolheadstable.php?sy=" + sy_id + "&user=" + teacher_id + "&sch=" + school_id, true);
            xmlhttp.send();
            return;
        }
    }
