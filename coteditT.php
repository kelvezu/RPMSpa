...
if(isset($_POST['password_sub'])):
    ...
    if($pwdCheck == false):
        header("location:displaytcotprogress.php?user_id=$teacher_id&obs=$obs&notif=pwerror");
    else: 
        header("location:coteditTpage.php?user_id=$teacher_id&obs=$obs&school_id=$school_id&sy_id=$sy");
    endif;
