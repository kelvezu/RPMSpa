                        ...
                        while ($row = $result->fetch_assoc()) :
                            ...
                            <thead class="thead-dark">
                                <tr>
                                    ...
                                    <th class="bg-info"><small><?php echo "KRA " . $kra_num; ?></small></th>
                                    <th class="bg-info"><small>Main MOV</small></th>
                                    <th class="bg-info"><small>Supporting MOV</small></th>
                                </tr>
                            </thead>
        ...
        <div class="col-sm-6">
            <div class="card" style="height:500px;">
                ...
                <div class="card-body box">
                    <div class="row">
                        <div class="col">
                            <form action="includes/uploadMT.php" method="post" enctype="multipart/form-data">
