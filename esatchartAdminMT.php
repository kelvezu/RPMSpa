        ...
        <script type="text/javascript">
            ...
            function AgeChart() {
                let data = google.visualization.arrayToDataTable([
                    ['Age', 'No. of Teacher'],
                    <?php
                            $qry = $conn->query("SELECT age_tbl.age_name, COUNT(esat1_demographicsmt_tbl.user_id) total FROM esat1_demographicsmt_tbl INNER JOIN age_tbl age_tbl on esat1_demographicsmt_tbl.age = age_tbl.age_id WHERE sy = '$sy' GROUP BY age_tbl.age_name") or die($conn->error);
...
FROM esat1_demographicsmt_tbl WHERE age = " . $agedemo['age_id'] . "  AND sy = '$sy' group by sy") or die($conn->error);
        ...
        <script type="text/javascript">
            ...
            function GenderChart() {
                let data = google.visualization.arrayToDataTable([
                    ...
                    <?php
                            $qry = $conn->query("SELECT esat1_demographicsmt_tbl.gender, COUNT(esat1_demographicsmt_tbl.user_id) total FROM esat1_demographicsmt_tbl WHERE sy = '$sy' GROUP BY esat1_demographicsmt_tbl.gender") or die($conn->error);
...
CASE WHEN sy = ('" . $_SESSION['active_sy_id'] . "')-1 THEN COUNT(`user_id`) END AS sy2, 
CASE WHEN sy = ('" . $_SESSION['active_sy_id'] . "')-2 THEN COUNT(`user_id`) END AS sy3  
FROM esat1_demographicsmt_tbl WHERE gender = '" . $genderdemo['gender_name'] . "'  AND sy = '$sy' group by sy") or die($conn->error);
        ...
        <script type="text/javascript">
            ...
            function EmploymentStatusChart() {
                let data = google.visualization.arrayToDataTable([
                    ...
                    <?php
                            $qry = $conn->query("SELECT esat1_demographicsmt_tbl.employment_status, COUNT(esat1_demographicsmt_tbl.user_id) total FROM esat1_demographicsmt_tbl WHERE sy = '$sy' GROUP BY esat1_demographicsmt_tbl.employment_status") or die($conn->error);
...
CASE WHEN sy = ('" . $_SESSION['active_sy_id'] . "')-1 THEN COUNT(`user_id`) END AS sy2, 
CASE WHEN sy = ('" . $_SESSION['active_sy_id'] . "')-2 THEN COUNT(`user_id`) END AS sy3  
FROM esat1_demographicsmt_tbl WHERE employment_status = '" . $employdemo['emp_status'] . "'  AND sy = '$sy' group by sy") or die($conn->error);
        ...
        <script type="text/javascript">
            ...
            function PositionChart() {
                let data = google.visualization.arrayToDataTable([
                    ...
                    <?php
                            $qry = $conn->query("SELECT esat1_demographicsmt_tbl.position, COUNT(esat1_demographicsmt_tbl.user_id)total FROM  esat1_demographicsmt_tbl WHERE sy = '$sy' GROUP BY esat1_demographicsmt_tbl.position ORDER BY esat1_demographicsmt_tbl.position desc") or die($conn->error);
...
CASE WHEN sy = ('" . $_SESSION['active_sy_id'] . "')-1 THEN COUNT(`user_id`) END AS sy2, 
CASE WHEN sy = ('" . $_SESSION['active_sy_id'] . "')-2 THEN COUNT(`user_id`) END AS sy3  
FROM esat1_demographicsmt_tbl WHERE position = '" . $positiondemo['position_name'] . "'  AND sy = '$sy' group by sy") or die($conn->error);
                                while ($PositionQry = $qry->fetch_assoc()) :
        ...
        <script type="text/javascript">
            ...
            function HighestDegreeChart() {
                let data = google.visualization.arrayToDataTable([
                    ...
                    <?php
                            $qry = $conn->query("SELECT esat1_demographicsmt_tbl.highest_degree, COUNT(esat1_demographicsmt_tbl.user_id) total FROM esat1_demographicsmt_tbl WHERE sy = '$sy' GROUP BY esat1_demographicsmt_tbl.highest_degree") or die($conn->error);
...
CASE WHEN sy = ('" . $_SESSION['active_sy_id'] . "')-1 THEN COUNT(`user_id`) END AS sy2, 
CASE WHEN sy = ('" . $_SESSION['active_sy_id'] . "')-2 THEN COUNT(`user_id`) END AS sy3  
FROM esat1_demographicsmt_tbl WHERE highest_degree = '" . $highestdegreedemo['degree_name'] . "'  AND sy = '$sy' group by sy") or die($conn->error);
        ...
        <script type="text/javascript">
            ...
            function TotalYearChart() {
                let data = google.visualization.arrayToDataTable([
                    ...
                    <?php
                            $qry = $conn->query("SELECT totalyear_tbl.totalyear_name,COUNT(esat1_demographicsmt_tbl.user_id)total from esat1_demographicsmt_tbl INNER JOIN totalyear_tbl on esat1_demographicsmt_tbl.totalyear=totalyear_tbl.totalyear_id WHERE sy = '$sy' GROUP BY totalyear_tbl.totalyear_name") or die($conn->error);
...
CASE WHEN sy = ('" . $_SESSION['active_sy_id'] . "')-1 THEN COUNT(`user_id`) END AS sy2, 
CASE WHEN sy = ('" . $_SESSION['active_sy_id'] . "')-2 THEN COUNT(`user_id`) END AS sy3  
FROM esat1_demographicsmt_tbl WHERE totalyear = " . $totalyeardemo['totalyear_id'] . "  AND sy = '$sy' group by sy") or die($conn->error);
            ...
            function SubjectTaught2Chart() {
                ...
                var data = google.visualization.arrayToDataTable([
                    ...
                    <?php
                            ...
                            $qry = $conn->query("SELECT subject_tbl.subject_name, COUNT(esat1_demographicsmt_tbl.user_id)total, 
CASE WHEN sy = '" . $_SESSION['active_sy_id'] . "' THEN  COUNT(`user_id`)  END AS sy1,
CASE WHEN sy = ('" . $_SESSION['active_sy_id'] . "')-1 THEN COUNT(`user_id`) END AS sy2, 
CASE WHEN sy = ('" . $_SESSION['active_sy_id'] . "')-2 THEN COUNT(`user_id`) END AS sy3  
FROM esat1_demographicsmt_tbl INNER JOIN subject_tbl ON esat1_demographicsmt_tbl.subject_taught LIKE CONCAT('%', subject_tbl.subject_name, '%') WHERE sy = '$sy' GROUP BY subject_tbl.subject_name") or die($conn->error);
        ...
        <script type="text/javascript">
            ...
            function GradeLvlTaughtChart() {
                let data = google.visualization.arrayToDataTable([
                    ...
                    <?php
                            $qry = $conn->query("SELECT gradelvltaught_tbl.gradelvltaught_name, COUNT(esat1_demographicsmt_tbl.user_id)total FROM gradelvltaught_tbl INNER JOIN esat1_demographicsmt_tbl ON esat1_demographicsmt_tbl.grade_lvl_taught LIKE CONCAT('%', gradelvltaught_tbl.gradelvltaught_id, '%') WHERE sy = '$sy' GROUP BY gradelvltaught_tbl.gradelvltaught_name") or die($conn->error);
            ...
            function GradeLvlTaught2Chart() {
                ...
                var data = google.visualization.arrayToDataTable([
                    ...
                    <?php
                            ...
                            $qry = $conn->query("SELECT gradelvltaught_tbl.gradelvltaught_name, COUNT(esat1_demographicsmt_tbl.user_id)total,
CASE WHEN sy = '" . $_SESSION['active_sy_id'] . "' THEN  COUNT(`user_id`)  END AS sy1,
CASE WHEN sy = ('" . $_SESSION['active_sy_id'] . "')-1 THEN COUNT(`user_id`) END AS sy2, 
CASE WHEN sy = ('" . $_SESSION['active_sy_id'] . "')-2 THEN COUNT(`user_id`) END AS sy3  
    FROM gradelvltaught_tbl INNER JOIN esat1_demographicsmt_tbl ON esat1_demographicsmt_tbl.grade_lvl_taught LIKE CONCAT('%', gradelvltaught_tbl.gradelvltaught_id, '%') WHERE sy = '" . $_SESSION['active_sy_id'] . "' GROUP BY gradelvltaught_tbl.gradelvltaught_name") or die($conn->error);
        ...
        <script type="text/javascript">
            ...
            function CurriClassChart() {
                let data = google.visualization.arrayToDataTable([
                    ...
                    <?php
                            $qry = $conn->query("SELECT curriclass_tbl.curriclass_name,COUNT(DISTINCT esat1_demographicsmt_tbl.user_id)total FROM esat1_demographicsmt_tbl INNER JOIN curriclass_tbl ON esat1_demographicsmt_tbl.curri_class = curriclass_tbl.curriclass_id WHERE sy = '$sy' GROUP BY curriclass_tbl.curriclass_name") or die($conn->error);
...
CASE WHEN sy = ('" . $_SESSION['active_sy_id'] . "')-1 THEN COUNT(`user_id`) END AS sy2, 
CASE WHEN sy = ('" . $_SESSION['active_sy_id'] . "')-2 THEN COUNT(`user_id`) END AS sy3  
FROM esat1_demographicsmt_tbl WHERE curri_class = " . $curridemo['curriclass_id'] . "  AND sy = '$sy' group by sy") or die($conn->error);
        ...
        <script type="text/javascript">
            ...
            function RegionChart() {
                let data = google.visualization.arrayToDataTable([
                    ...
                    <?php
                            $qry = $conn->query("SELECT *,region_tbl.region_name, COUNT(esat1_demographicsmt_tbl.user_id)total from region_tbl INNER JOIN esat1_demographicsmt_tbl ON region_tbl.reg_id = esat1_demographicsmt_tbl.region WHERE sy = '$sy' GROUP BY region_tbl.region_name") or die($conn->error);
...
CASE WHEN sy = ('" . $_SESSION['active_sy_id'] . "')-1 THEN COUNT(`user_id`) END AS sy2, 
CASE WHEN sy = ('" . $_SESSION['active_sy_id'] . "')-2 THEN COUNT(`user_id`) END AS sy3  
FROM esat1_demographicsmt_tbl WHERE region = " . $regiondemo['reg_id'] . "  AND sy = '$sy' group by sy") or die($conn->error);
    ...
    " . intval($regionQry['sy3']) . "],";
        ...
        <script type="text/javascript">
            ...
            function SelfAssessmentChart() {
                ...
                LEFT JOIN (select mtobj_id,count(DISTINCT user_id)low from esat2_objectivesmt_tbl WHERE lvlcap = 1 AND sy = '$sy' GROUP BY mtobj_id,lvlcap) as b on a.mtobj_id =b.mtobj_id 
                LEFT JOIN (select mtobj_id,count(DISTINCT user_id)low from esat2_objectivesmt_tbl WHERE lvlcap = 2 AND sy = '$sy' GROUP BY mtobj_id,lvlcap) as c on a.mtobj_id =c.mtobj_id 
                LEFT JOIN (select mtobj_id,count(DISTINCT user_id)low from esat2_objectivesmt_tbl WHERE lvlcap = 3 AND sy = '$sy' GROUP BY mtobj_id,lvlcap) as d on a.mtobj_id =d.mtobj_id 
                LEFT JOIN (select mtobj_id,count(DISTINCT user_id)low from esat2_objectivesmt_tbl WHERE lvlcap = 4 AND sy = '$sy' GROUP BY mtobj_id,lvlcap) as e on a.mtobj_id =e.mtobj_id 
                LEFT JOIN (select mtobj_id,count(DISTINCT user_id)low from esat2_objectivesmt_tbl WHERE priodev = 1 AND sy = '$sy' GROUP BY mtobj_id,lvlcap) as f on a.mtobj_id =f.mtobj_id 
                LEFT JOIN (select mtobj_id,count(DISTINCT user_id)low from esat2_objectivesmt_tbl WHERE priodev = 2 AND sy = '$sy' GROUP BY mtobj_id,lvlcap) as g on a.mtobj_id =g.mtobj_id 
                LEFT JOIN (select mtobj_id,count(DISTINCT user_id)low from esat2_objectivesmt_tbl WHERE priodev = 3 AND sy = '$sy' GROUP BY mtobj_id,lvlcap) as h on a.mtobj_id =h.mtobj_id 
                LEFT JOIN (select mtobj_id,count(DISTINCT user_id)low from esat2_objectivesmt_tbl WHERE priodev = 4 AND sy = '$sy' GROUP BY mtobj_id,lvlcap) as i on a.mtobj_id =i.mtobj_id 
            ...
            function CoreBehavioralChart() {
                let data = google.visualization.arrayToDataTable([
                    ...
                    <?php
                            ...
                            $CoreBehavioralqry = mysqli_query($conn, "SELECT a.cbc_id, count(a.sc1)score1,COUNT(a.sc2)score2,COUNT(a.sc3)score3,COUNT(a.sc4)score4,count(a.sc5)score5 FROM ( select sy,cbc_id,user_id,
                ...
                FROM esat3_core_behavioralmt_tbl GROUP BY cbc_id,user_id)a WHERE sy = '$sy'
        ...
        <script type="text/javascript">
            ...
            function AgeChart() {
                let data = google.visualization.arrayToDataTable([
                    ['Age', 'No. of Teacher'],
                    <?php
                            $qry = $conn->query("SELECT age_tbl.age_name, COUNT(esat1_demographicsmt_tbl.user_id) total FROM esat1_demographicsmt_tbl INNER JOIN age_tbl age_tbl on esat1_demographicsmt_tbl.age = age_tbl.age_id WHERE sy = '$sy_id' AND school = '$school' GROUP BY age_tbl.age_name") or die($conn->error);
                            while ($AgeChart = $qry->fetch_assoc()) :
                                echo "['" . $AgeChart['age_name'] . "', " . $AgeChart['total'] . "],";
                            endwhile; ?>
                ]);
...
CASE WHEN sy = ('" . $_SESSION['active_sy_id'] . "')-1 THEN COUNT(`user_id`) END AS sy2, 
CASE WHEN sy = ('" . $_SESSION['active_sy_id'] . "')-2 THEN COUNT(`user_id`) END AS sy3  
FROM esat1_demographicsmt_tbl WHERE age = " . $agedemo['age_id'] . "  AND sy = '$sy_id' AND school = '$school' group by sy") or die($conn->error);
                                while ($AgeQry = $qry->fetch_assoc()) :
                                    echo "['" . $agedemo['age_name'] . "', 
    " . intval($AgeQry['sy1']) . ",  
    " . intval($AgeQry['sy2']) . ",   
