...
<div class="container col-md-9">
    ...
    <div class="bg-dark h4 text-white breadcrumb">Master Teacher Individual Development Plan</div>
    <div class="px-3">
...
<script>
    ...
    function showAve() {
        ...
        if ((sy_id == "" || teacher_id == "")) {
            ...
            xmlhttp.open("GET", "viewdevplanMTprincipaltable.php?sy=" + sy_id + "&user=" + teacher_id + "&sch=" + school_id, true);
            xmlhttp.send();
            return;
        }
    }
