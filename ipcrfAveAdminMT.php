...
<div class="container col-md-9">
    ...
    <div class="px-3">
       ...
       <form action="ipcrfAveAdminChartMT.php" method="POST" class="form-inline">
...
<script>
    ...
    function showAve() {
        ...
        if ((sy_id == "" || school_id == "")) {
            ...
            xmlhttp.open("GET", "ipcrfAveMTadmintableGeneral.php?sy=" + active_sy_id, true);
            xmlhttp.send();
            return;
        } else {
            let xmlhttp = new XMLHttpRequest();
            ...
            xmlhttp.open("GET", "ipcrfAveMTadmintable.php?sy=" + sy_id + "&sch=" + school_id, true);
            xmlhttp.send();
            return;
        }
    }
