...
<div class="container col-md-9">
    ...
    <div class="px-3">
        ...
        <form action="ipcrfchartMTprincipal.php" method="POST" class="form-inline">
...
<script>
    ...
    function showAve() {
        ...
        if ((sy_id == "" || teacher_id == "")) {
            ...
            xmlhttp.open("GET", "ipcrfAveMTprincipaltableGeneral.php?sy=" + active_sy_id + "&sch=" + school_id, true);
            xmlhttp.send();
            return;
        } else {
            let xmlhttp = new XMLHttpRequest();
            ...
            xmlhttp.open("GET", "ipcrfAveMTprincipaltable.php?sy=" + sy_id + "&user=" + teacher_id + "&sch=" + school_id, true);
            xmlhttp.send();
            return;
        }
    }
