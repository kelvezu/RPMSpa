...
<div class="container-fluid">
    ...
    <div class="row">
        ...
        <!-- End of 2nd column of First row   -->
        ...
        <div class="col">
            <div class="card">
                <div class="card-header">
                    <div class="d-flex">
                        <div class="w-100">
                            <h6><i class="fa fa-users"></i> Master Teacher ESAT Level Capability Result</h6>
                        </div>
                    </div>
                </div>
                <!-- Card Body -->
        ...
        <div class="col">
            <div class="card">
                <div class="card-header">
                    <div class="d-flex">
                        <div class="w-100">
                            <h6><i class="fa fa-users"></i> Master Teacher ESAT Level of Priority Result</h6>
                        </div>
                    </div>
                </div>
                <!-- Card Body -->
    ...
    <script type="text/javascript">
      ...
      function chartCoT() {
        ...
        (SELECT indicator_id,AVG(average) AS T_average,
          ...
          FROM cot_mt_indicator_ave_tbl WHERE school = '".$_SESSION['school_id']."' and user_id = '".$_SESSION['user_id']."' GROUP BY indicator_id,average,sy) a
    ...
    function SelfAssessmentChart() {
        let data = google.visualization.arrayToDataTable([
            ...
            $qry = mysqli_query($conn, "SELECT a.mtobj_id, b.low as L_LOW, c.low as L_MODERATE, d.low as L_HIGH, e.low as L_VERY_HIGH, f.low as P_LOW, g.low as P_MODERATE, h.low as P_HIGH, i.low as P_VERY_HIGH from mtobj_tbl a 
                LEFT JOIN (select mtobj_id,count(DISTINCT user_id)low from esat2_objectivesmt_tbl WHERE lvlcap = 1 AND sy = '" . $_SESSION['active_sy_id'] . "'  AND school = '".$_SESSION['school_id']."' and user_id = '".$_SESSION['user_id']."' GROUP BY mtobj_id,lvlcap) as b on a.mtobj_id =b.mtobj_id 
                LEFT JOIN (select mtobj_id,count(DISTINCT user_id)low from esat2_objectivesmt_tbl WHERE lvlcap = 2 AND sy = '" . $_SESSION['active_sy_id'] . "'  AND school = '".$_SESSION['school_id']."' and user_id = '".$_SESSION['user_id']."' GROUP BY mtobj_id,lvlcap) as c on a.mtobj_id =c.mtobj_id 
                LEFT JOIN (select mtobj_id,count(DISTINCT user_id)low from esat2_objectivesmt_tbl WHERE lvlcap = 3 AND sy = '" . $_SESSION['active_sy_id'] . "'  AND school = '".$_SESSION['school_id']."' and user_id = '".$_SESSION['user_id']."' GROUP BY mtobj_id,lvlcap) as d on a.mtobj_id =d.mtobj_id 
                LEFT JOIN (select mtobj_id,count(DISTINCT user_id)low from esat2_objectivesmt_tbl WHERE lvlcap = 4 AND sy = '" . $_SESSION['active_sy_id'] . "'  AND school = '".$_SESSION['school_id']."' and user_id = '".$_SESSION['user_id']."' GROUP BY mtobj_id,lvlcap) as e on a.mtobj_id =e.mtobj_id 
                LEFT JOIN (select mtobj_id,count(DISTINCT user_id)low from esat2_objectivesmt_tbl WHERE priodev = 1 AND sy = '" . $_SESSION['active_sy_id'] . "'  AND school = '".$_SESSION['school_id']."' and user_id = '".$_SESSION['user_id']."' GROUP BY mtobj_id,lvlcap) as f on a.mtobj_id =f.mtobj_id 
                LEFT JOIN (select mtobj_id,count(DISTINCT user_id)low from esat2_objectivesmt_tbl WHERE priodev = 2 AND sy = '" . $_SESSION['active_sy_id'] . "'  AND school = '".$_SESSION['school_id']."' and user_id = '".$_SESSION['user_id']."' GROUP BY mtobj_id,lvlcap) as g on a.mtobj_id =g.mtobj_id 
                LEFT JOIN (select mtobj_id,count(DISTINCT user_id)low from esat2_objectivesmt_tbl WHERE priodev = 3 AND sy = '" . $_SESSION['active_sy_id'] . "'  AND school = '".$_SESSION['school_id']."' and user_id = '".$_SESSION['user_id']."' GROUP BY mtobj_id,lvlcap) as h on a.mtobj_id =h.mtobj_id 
                LEFT JOIN (select mtobj_id,count(DISTINCT user_id)low from esat2_objectivesmt_tbl WHERE priodev = 4 AND sy = '" . $_SESSION['active_sy_id'] . "'  AND school = '".$_SESSION['school_id']."' and user_id = '".$_SESSION['user_id']."' GROUP BY mtobj_id,lvlcap) as i on a.mtobj_id =i.mtobj_id 
