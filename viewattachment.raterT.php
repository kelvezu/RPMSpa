...
$cot_count  = $ipcrf->fetchObsPeriodinCOT('cot_t_rating_a_tbl');
// pre_r($cot_count);
?>
                        ...
                        foreach ($mov_b as $mov) : ?>
                            ...
                            <td>
                                ...
                                if ($mov['mov_type'] == "COT") :
                                    ...
                                    ?>
                                    <?php $main_att = rpmsdb::fetch_MAIN_T_MOV_ATT($conn, $user_id, $_SESSION['school_id'], $_SESSION['active_sy_id'], $mov['tobj_id'], $mov['kra_id']);
                                    if (isset($main_att)) :
                                        foreach ($main_att as $mmov) : ?>
                                            <p class="text-justify text-nowrap">
                                                <button data-toggle="modal" data-target="#updateModal<?php echo $mmov['mov_id'] . $mov['tobj_id'] ?>" class="btn btn-outline-primary btn-sm"><?php echo displayMOVfileT($conn, $mmov['mov_id']);  ?>
                                                </button>
                            ...
                            <td>
                                ...
                                <?php
                                if ($mov['mov_type'] == "COT") {
                                    if (get_cot_average_indicator_t($conn, $user_id, $_SESSION['active_sy_id'], $_SESSION['school_id'], $mov['indicator_id'])) {
                                        echo ('<p class="text-center">' . get_cot_average_indicator_t($conn, $user_id, $_SESSION['active_sy_id'], $_SESSION['school_id'], $mov['indicator_id']) . '</p>');
                                    }
                                }
                                ...
                                <?php /* foreach (tobj_tbl($conn) as $obj) :
                                    if ($obj['mov_type'] == "COT") : ?>
                                        <p>I'm a cot</p>
                            ...
                            <td>
                                ...
                                ?>
                                        <p class="text-justify text-nowrap">
                                            <button data-toggle="modal" data-target="#updateModal<?php echo $smov['mov_id'] . $mov['tobj_id'] ?>" class="btn btn-outline-primary btn-sm"><?php echo  displayMOVfileT($conn, $smov['mov_id']) ?>
                                            </button>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <table class="table table-bordered table-striped table-sm table-responsive-sm">
                        ...
                        <tbody>
                            <?php
                            $cot_details = $ipcrf->fetchCOTdetails($c_count['obs_period'], 'cot_t_rating_a_tbl');
                            $cot_num = 1;
                            if ($cot_details) :
                            ...
                            ?>
                                    <tr>
                                        ...
                                        <td>
                                            <p class="font-italic">
                                                <?= displayTindicator($conn, $cot['indicator_id']); ?>
                                            </p>
                                        </td>
                        ...
                        <tfoot>
                            <tr>
                                <td colspan="6">
                                    <textarea class="form-control" disabled><?= get_cot_feedback_t($conn, $user_id, $_SESSION['active_sy_id'], $_SESSION['school_id'], $c_count['obs_period']) ?></textarea>
                                </td>
                            </tr>
