                ...
                <div class="container-fluid">
                    <div class="row">
                        ...
                        <div class="col-lg-5" >
                            ...
                            <div class="dashone-adminprowrap shadow-reset mg-b-30">
                                <h1>KRA 4 - Assessment and Reporting</h1>
                            </div>  
                                <div class="dashone-adminprowrap shadow-reset mg-b-30">
                                    <h5><b>Objective 10</b> <br>  Worked collaboratively with colleagues to review the design, selection, organization and use of a range of effective diagnostic, formative and summative assessment strategies consistent with curriculum requirements.</h5>
                            ...
                            <h6>MOV Attachment Progress &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <a href="#">View Attachments</a></h6>
                                ...
                                <div class="dashone-adminprowrap shadow-reset mg-b-30">
                                    <h5><b>Objective 11 </b><br>  Interpreted collaboratively monitoring and evaluation strategies of attainment data to support learner progress and achievement.</h5>                                         <div class="analysis-progrebar-content">
                            ...
                            <h6>MOV Attachment Progress &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <a href="#">View Attachments</a></h6>
                                ...
                                <div class="dashone-adminprowrap shadow-reset mg-b-30">
                                    <h5><b>Objective 12 </b><br> Applied skills in the effective communication of learner needs, progress and achievement to key stakeholders, including parents/guardians.</h5>
                                        <div class="analysis-progrebar-content">
                                        <h5><span class="counter">50</span>%</h5>
                                                    <div class="progress progress-mini">
                                                        <div style="width: 50%;" class="progress-bar">          
