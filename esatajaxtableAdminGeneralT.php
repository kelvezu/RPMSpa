        ...
        <div class="row">
            <div class="col">
                <table class="table table-bordered hover table-sm">
                    ...
                    <tbody>
                        <?php
                        $qry = $conn->query("SELECT age_tbl.age_name, COUNT(esat1_demographicst_tbl.user_id) total FROM esat1_demographicst_tbl INNER JOIN age_tbl age_tbl on esat1_demographicst_tbl.age = age_tbl.age_name WHERE sy = '$sy' GROUP BY age_tbl.age_name");
        ...
        <div class="row">
            <div class="col">
                <table class="table table-bordered hover table-sm">
                    ...
                    <tbody>
                        <?php
                        $qry = $conn->query("SELECT esat1_demographicst_tbl.employment_status, COUNT(esat1_demographicst_tbl.user_id) total FROM esat1_demographicst_tbl WHERE sy = '$sy' GROUP BY esat1_demographicst_tbl.employment_status");
                        while ($esatresult = $qry->fetch_assoc()) : ?>
                            <tr>
        ...
        <div class="row">
            <div class="col">
                <table class="table table-bordered hover table-sm">
                    ...
                    <tbody>
                        <?php
                        $qry = $conn->query("SELECT esat1_demographicst_tbl.position, COUNT(esat1_demographicst_tbl.user_id)total FROM  esat1_demographicst_tbl WHERE sy = '$sy' GROUP BY esat1_demographicst_tbl.position ORDER BY esat1_demographicst_tbl.position desc");
                        while ($esatresult = $qry->fetch_assoc()) : ?>
                            <tr>
        ...
        <div class="row">
            <div class="col">
                <table class="table table-bordered hover table-sm">
                    ...
                    <tbody>
                        <?php
                        $qry = $conn->query("SELECT esat1_demographicst_tbl.highest_degree, COUNT(esat1_demographicst_tbl.user_id) total FROM esat1_demographicst_tbl WHERE sy = '$sy' GROUP BY esat1_demographicst_tbl.highest_degree");
                        while ($esatresult = $qry->fetch_assoc()) : ?>
                            <tr>
        ...
        <div class="row">
            <div class="col">
                <table class="table table-bordered hover table-sm">
                    ...
                    <tbody>
                        <?php
                        $qry = $conn->query("SELECT totalyear_tbl.totalyear_name,COUNT(esat1_demographicst_tbl.user_id)total from esat1_demographicst_tbl INNER JOIN totalyear_tbl on esat1_demographicst_tbl.totalyear=totalyear_tbl.totalyear_id WHERE sy = '$sy' GROUP BY totalyear_tbl.totalyear_name");
                        while ($esatresult = $qry->fetch_assoc()) : ?>
                            <tr>
            ...
            <div class="col">
                <table class="table table-bordered hover table-sm">
                    ...
                    <tbody>
                        ...
                        <?php
                        $qry = $conn->query("SELECT subject_tbl.subject_name, COUNT(esat1_demographicst_tbl.user_id)total, esat1_demographicst_tbl.* FROM esat1_demographicst_tbl INNER JOIN subject_tbl ON esat1_demographicst_tbl.subject_taught LIKE CONCAT('%', subject_tbl.subject_name, '%') WHERE sy = '$sy' GROUP BY subject_tbl.subject_name ");
            ...
            <div class="col">
                <table class="table table-bordered hover table-sm">
                    ...
                    <tbody>
                        ...
                        <?php
                        $qry = $conn->query("SELECT curriclass_tbl.curriclass_name,COUNT(DISTINCT esat1_demographicst_tbl.user_id)total FROM esat1_demographicst_tbl INNER JOIN curriclass_tbl ON esat1_demographicst_tbl.curri_class = curriclass_tbl.curriclass_id WHERE sy = '$sy' GROUP BY curriclass_tbl.curriclass_name");
                        while ($esatresult = $qry->fetch_assoc()) : ?>
                            <tr>
            ...
            <div class="col">
                <table class="table table-bordered hover table-sm">
                    ...
                    <tbody>
                        ...
                        <?php
                        $qry = $conn->query("SELECT *,region_tbl.region_name, COUNT(esat1_demographicst_tbl.user_id)total from region_tbl INNER JOIN esat1_demographicst_tbl ON region_tbl.reg_id = esat1_demographicst_tbl.region WHERE sy = '$sy' GROUP BY region_tbl.region_name");
                        while ($esatresult = $qry->fetch_assoc()) : ?>
                            <tr>
