                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-5" >
                            ...
                            <div class="dashone-adminprowrap shadow-reset mg-b-30">
                                ...
                                <div class="dashone-adminprowrap shadow-reset mg-b-30">
                                    <h5><b>Objective 1</b> <br> Modeled effective applications of content knowledge within and across curriculum teaching areas.</h5>
                            ...
                            <h6>MOV Attachment Progress &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <a href="#">View Attachments</a></h6>
                                ...
                                <div class="dashone-adminprowrap shadow-reset mg-b-30">
                                    <h5><b>Objective 2 </b><br> Collaborated with colleagues in the conduct and application of research to enrich knowledge of content and pedagogy.</h5>
                                        <div class="analysis-progrebar-content">
                                        <h6><span class="counter">50</span>%</h6>
                                                    <div class="progress progress-mini">
                                                        <div style="width: 50%;" class="progress-bar">          
                            ...
                            <h6>MOV Attachment Progress &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <a href="#">View Attachments</a></h6>
                                ...
                                <div class="dashone-adminprowrap shadow-reset mg-b-30">
                                    <h5><b>Objective 3 </b><br>  Developed and applied effective teaching strategies to promote critical and creative thinking, as well as other higher-order thinking skills.</h5>
                                        <div class="analysis-progrebar-content">
                                        <h6><span class="counter">50</span>%</h6>
                                                    <div class="progress progress-mini">
                                                        <div style="width: 50%;" class="progress-bar">          
