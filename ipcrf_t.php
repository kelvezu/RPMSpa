                    ...
                    <tr>
                        ...
                        <td>
                            <p class="font-weight-bold text-center">
                                ...
                                <?php
                                    if ($kra['tobj_id'] == 1) : echo ($ipcrf->getIndicatorAVGt(1)) ?? 0;
                                    elseif ($kra['tobj_id'] == 3) : echo ($ipcrf->getIndicatorAVGt(2)) ?? 0;
                                    elseif ($kra['tobj_id'] == 4) : echo ($ipcrf->getIndicatorAVGt(3)) ?? 0;
                                    elseif ($kra['tobj_id'] == 5) : echo ($ipcrf->getIndicatorAVGt(4)) ?? 0;
                                    elseif ($kra['tobj_id'] == 7) : echo ($ipcrf->getIndicatorAVGt(5)) ?? 0;
                                    else :   echo $ipcrf->countMOV($kra['kra_id'], $kra['tobj_id'], 'mov_main_t_attach_tbl') ?? 0;
                                    endif; ?>
                                <!-- ------------------------------------------------- -->
                            </p>
                        </td>
                        ...
                        <td>
                            <p class="font-weight-bold text-center">
                                <?php echo  $ipcrf->getEfficiency($kra['kra_id'], $kra['tobj_id'], 'mov_supp_t_attach_tbl')  ?? 0 ?>
                            </p>
                        </td>
