...
<div class="container">
    ...
    <div class="h4 breadcrumb alert alert-danger text-center">Delete Rubric Confirmation</div>
        ...
        <div class="row my-4">
            <div class="col-md-6">
            <a href="../includes/processtrubric.php?delete=<?php echo $rubric_id;?>" class="btn btn-danger btn-block">Delete</a>
            </div>
            <div class="col-md-6">
            <a href="../displaytrubric.php" class="btn btn-primary btn-block">Cancel</a>
            </div>
        </div>
    </div>
        </div>
