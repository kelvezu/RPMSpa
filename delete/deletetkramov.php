...
<div class="container">
    ...
    <div class="h4 breadcrumb alert alert-danger text-center">Delete Objective Confirmation</div>
        ...
        <p class="h5">Do you want to delete <b><u><?php echo $tobj_name; ?></u></b> objective from the database?</p>
        <div class="row my-4">
            <div class="col-md-6">
            <a href="../includes/processtkramov.php?delete=<?php echo $tobj_id;?>" class="btn btn-danger btn-block">Delete</a>
            </div>
            <div class="col-md-6">
...
<div class="container">
    ...
    <div class="h4 breadcrumb alert alert-danger text-center">Delete KRA Confirmation</div>
        ...
        <div class="row my-4">
            <div class="col-md-6">
            <a href="../includes/processtkramov.php?deletekra=<?php echo $kra_id;?>" class="btn btn-danger btn-block">Delete</a>
            </div>
            <div class="col-md-6">
            <a href="../displaytkramov.php" class="btn btn-primary btn-block">Cancel</a>
            </div>
