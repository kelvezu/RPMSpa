...
<div class="container">
    ...
    <div class="card">
     <div class="card-body">
    <div class="h4 breadcrumb alert alert-danger text-center">Delete Total Year Confirmation</div>
        <input type="hidden" name="totalyear_id" value="<?php echo $totalyear_id; ?>"/>
        <p class="h5">Do you want to delete <b><?php echo $totalyear_name; ?></b> from the database?</p>
        <div class="row my-4">
            <div class="col-md-6">
            <a href="../includes/processESAT.php?deleteTY=<?php echo $totalyear_id;?>" class="btn btn-danger btn-block">Delete</a>
            </div>
            <div class="col-md-6">
