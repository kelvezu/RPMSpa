...
<main>
    <div class="container">
        <div class="breadcome-list map-mg-t-40-gl shadow-reset text-center">
            <div class="card">
                <div class="card-body">
                    <div class="h4 breadcrumb alert alert-danger text-center">Delete gender Confirmation</div>
                    <input type="hidden" name="gender_id" value="<?php echo $gender_id; ?>" />
                    <p class="h5">Do you want to delete <b><?php echo $gender_name; ?></b> from the database?</p>
                    <div class="row my-4">
                        <div class="col-md-6">
                            <a href="../includes/processESAT.php?deleteGEN=<?php echo $gender_id; ?>" class="btn btn-danger btn-block">Delete</a>
                        </div>
                        <div class="col-md-6">
