        ...
        <div class="breadcome-list map-mg-t-40-gl shadow-reset text-center">
            <div class="card">
                <div class="card-body">
                    ...
                    <p class="h5">Do you want to remove <b><u><?php echo $mtobj_name; ?></u></b> objective from the selection?</p>
                    <div class="row my-4">
                        <div class="col-md-6">
                            <a href="../includes/processmtkramov.php?delete=<?php echo $mtobj_id; ?>" class="btn btn-danger btn-block">Remove</a>
                        </div>
                        <div class="col-md-6">
        ...
        <div class="breadcome-list map-mg-t-40-gl shadow-reset text-center">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="row my-4">
                        <div class="col-md-6">
                            <a href="../includes/processmtkramov.php?deletekra=<?php echo $kra_id; ?>" class="btn btn-danger btn-block">Remove</a>
                        </div>
                        <div class="col-md-6">
                            <a href="../displaymtkramov.php" class="btn btn-primary btn-block">Cancel</a>
                        </div>
