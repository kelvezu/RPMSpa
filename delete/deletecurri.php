...
<div class="container">
    ...
    <div class="card">
     <div class="card-body">
    <div class="h4 breadcrumb alert alert-danger text-center">Delete Curricular Classification Taught Confirmation</div>
        <input type="hidden" name="curriclass_id" value="<?php echo $curriclass_id; ?>"/>
        <p class="h5">Do you want to delete <b><?php echo $curriclass_name; ?></b> from the database?</p>
        <div class="row my-4">
            <div class="col-md-6">
            <a href="../includes/processESAT.php?deleteCURRI=<?php echo $curriclass_id;?>" class="btn btn-danger btn-block">Delete</a>
            </div>
            <div class="col-md-6">
