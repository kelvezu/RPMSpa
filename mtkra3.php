                ...
                <div class="container-fluid">
                    <div class="row">
                        ...
                        <div class="col-lg-5" >
                            ...
                            <div class="dashone-adminprowrap shadow-reset mg-b-30">
                                <h1>KRA 3 - Curriculum and Planning</h1>
                            </div>  
                                <div class="dashone-adminprowrap shadow-reset mg-b-30">
                                    <h5><b>Objective 7</b> <br>   Developed and applied effective strategies in the planning and management of developmentally sequenced teaching and learning processes to meet curriculum requirements and varied teaching contexts.</h5>
                            ...
                            <h6>MOV Attachment Progress &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <a href="#">View Attachments</a></h6>
                                ...
                                <div class="dashone-adminprowrap shadow-reset mg-b-30">
                                    <h5><b>Objective 8 </b><br> Reviewed with colleagues, teacher and learner feedback to plan, facilitate and enrich teaching practice.</h5>
                                        <div class="analysis-progrebar-content">
                            ...
                            <h6>MOV Attachment Progress &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <a href="#">View Attachments</a></h6>
                                ...
                                <div class="dashone-adminprowrap shadow-reset mg-b-30">
                                    <h5><b>Objective 9 </b><br>  Advised and guided colleagues in the selection, organization, development and use of appropriate teaching and learning resources, including ICT, to address specific learning goals.</h5>
                                        <div class="analysis-progrebar-content">
                                        <h5><span class="counter">50</span>%</h5>
                                                    <div class="progress progress-mini">
                                                        <div style="width: 50%;" class="progress-bar">          
