                ...
                <tbody class="font-weight-bold">
                    ...
                    foreach ($KRAandOBJ as $kra) : ?>
                        <tr>
                            ...
                            <!-- DISPLAY KRA LIST -->
                            <td>
                                <p data-toggle="tooltip" data-placement="top" title="<?= displayKRA($conn, $kra['tobj_id']) ?>" class="text-wrap">
                            ...
                            <!-- DISPLAY OBJECTIVE -->
                            <td>
                                <p data-toggle="tooltip" data-placement="top" title="<?= displayObjectiveMT($conn, $kra['tobj_id']) ?>">Objective <?= $kra['tobj_id'] ?></p>
                            </td>
                            <!-- ----------------- -->
