                        ...
                        <tr>
                            ...
                            <td>
                                <details>
                                    ...
                                    <p><?= displayKRA($conn, $kra['tobj_id']) ?></p>
                                </details>
                                </p>
                            </td>
                            <!-- ------------------- -->
                            ...
                            <td>
                                <p>
                                    <details>
                                        <summary>Objective <?= $kra['tobj_id'] ?></summary>
                                        <p><?= displayObjectiveT($conn, $kra['tobj_id']) ?></p>
                                    </details>
                                </p>
                            </td>
                            <!-- ----------------- -->
                            ...
                            <td class="text-justify">
                                ...
                                if ($kra['classroom_observable'] == "Yes") :
                                    $cot_count = fullCOTCountt($conn, $user_id, $active_sy_id, $school_id);
                                    if ($cot_count) : ?>
                                                                                ...
                                                                                <tr>
                                                                                    ...
                                                                                    <td>
                                                                                        <p>
                                                                                            <details>
                                                                                                <summary>
                                                                                                    Objective <?php echo $cot_r['tobj_id'] ?>
                                                                                                </summary>

                                                                                                <p>
                                                                                                    <?php echo displayObjectiveT($conn, $cot_r['tobj_id']) ?>
                                                                                                </p>
                                                                                            </details>
                                                                                    ...
                                                                                    <td>
                                                                                        <p>
                                                                                            <details>
                                                                                                ...
                                                                                                <p>
                                                                                                    <?php echo displayTindicator($conn, $cot_r['indicator_id']) ?>
                                                                                                </p>
                                                                                            </details>
                                                                                    ...
                                                                                    <?php foreach ($cot_count as $cc) :  ?>
                                                                                        <td>
                                                                                            ...
                                                                                            ?>
                                                                                            <p>
                                                                                                <?php $indicator_rating = fetch_cot_rating_t($conn, $cc['obs_period'],  $cot_r['indicator_id'], $active_sy_id, $school_id) ?>
                                                                                    ...
                                                                                    <td>
                                                                                        <p>
                                                                                            <?php
                                                                                            $indicator_average = fetch_indicator_avg_t($conn, $user_id,  $cot_r['indicator_id'], $active_sy_id, $school_id);
                                ...
                                elseif ($kra['classroom_observable'] == "No") :
                                    ...
                                    $main_mov = rpmsdb::fetch_MAIN_T_MOV_ATT($conn, $user_id, $_SESSION['school_id'], $_SESSION['active_sy_id'], $kra['tobj_id'], $kra['kra_id']);


                                    if (isset($main_mov)) :
                                        foreach ($main_mov as $mmov) : ?>
                                            <p>
                                                <button data-toggle="modal" data-target="#updateModal<?= $mmov['mov_id'] . $kra['tobj_id'] ?>" class="btn btn-outline-primary btn-sm">
                                                    <?= displayMOVfileT($conn, $mmov['mov_id']) ?>
                                                    <a href="includes/processattachuser.php?type=main&attach_mov_id=<?= $mmov['mov_id'] ?>" class="fa fa-times text-danger"></a>
                                                </button>
                                            </p>

                                            <!--Main MOV Modal -->
                                            <div class="modal fade" id="updateModal<?= $mmov['mov_id'] .   $kra['tobj_id'] ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                <div class="modal-dialog modal-lg" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <div class="card">
                                                                <div class="card-header bg-light">
                                                                    ...
                                                                    <b>Attached in Objective <?= $kra['tobj_id'] ?>: </b>
                                                                    "<i><?= displayObjectiveT($conn, $kra['tobj_id']) ?></i>"
                                                                </div>
                                                                <div class="card-body">
                                                                    <div class="card">
                                                                        <div class="card-header bg-dark text-white">
                                                                            <div class="d-flex justify-content-between">
                                                                                <div class="p-2">
                                                                                    <p><b>File name:</b>
                                                                                        <?php echo displayMOVfileT($conn, $mmov['mov_id']) ?></p>
                                                                                </div>
                                                                                <form action="includes/processAttachUser.php" method="POST">
                                                                                    ...
                                                                                    <input type="hidden" value="<?= $kra['tobj_id'] ?>" name="obj_id">
                                                                                    <input type="hidden" value="<?= $mmov['mov_type'] ?>" name="mov_type">
                                                                                    <div class="p-2"><button type="submit" class="btn btn-sm btn-outline-danger" name="remove_t_attach">Remove Attachment</button></div>
                                                                                </form>
                                                                            </div>
                                                                        </div>
                                                                        <div class="card-body">
                                                                            <form action="includes/processupdateattachment.php" method="post">
                                                                                <div class="row">
                                                                                    <div class="col">
                                                                                        <p><b>Attachment</b>
                                                                                            <p><?= (displayFileT($conn, $mmov['mov_id'])); ?></p>
                                                                                        </p>
                                                                                    </div>
                                                                                </div>
                                                        ...
                                                        <div class="modal-footer">
                                                            ...
                                                            <!-- <a class="btn btn-outline-primary btn-sm" href="downloadt.php?file=<?php //$smov['attachment'] 
                                                                                                                                    ?>">View File</a> -->
                            ...
                            <td>
                                ...
                                <?php
                                $fetch_main_status = rpmsdb::fetch_MAIN_T_MOV_ATT($conn, $user_id, $_SESSION['school_id'], $_SESSION['active_sy_id'], $kra['tobj_id'], $kra['kra_id']);
                            ...
                            <td class=" text-justify">
                                <!-- COLUMN FOR SUPP MOV -->
                                <?php
                                $supp_mov =  rpmsdb::fetch_SUPP_T_MOV_ATT($conn, $user_id, $_SESSION['school_id'], $_SESSION['active_sy_id'], $kra['tobj_id'], $kra['kra_id']);
                                ...
                                ?>
                                        <p class="text-justify text-nowrap">
                                            ...
                                            <button data-toggle="modal" data-target="#updateModal<?= $smov['mov_id'] . $kra['tobj_id'] ?>" class="btn btn-outline-primary btn-sm">
                                                <?= displayMOVfileT($conn, $smov['mov_id']) ?>
                                        ...
                                        <!--Main SUPP Modal -->
                                        <div class="modal fade" id="updateModal<?php echo $smov['mov_id'] . $kra['tobj_id'] ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                            <div class="modal-dialog modal-lg" role="document">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title" id="exampleModalLabel">Update Attachments</h5>
                                                    ...
                                                    <div class="modal-body">
                                                        <div class="card">
                                                            <div class="card-header bg-light">
                                                                ...
                                                                <b>Attached in Objective <?php echo $kra['tobj_id'] ?>: </b>
                                                                "<i><?php echo displayObjectiveT($conn, $kra['tobj_id']) ?></i>"
                                                            </div>
                                                            <div class="card-body">
                                                                <div class="card">
                                                                    <div class="card-header bg-dark text-white">
                            ...
                            <td class="text-center">
                                ...
                                <?php
                                $fetch_supp_status = rpmsdb::fetch_SUPP_T_MOV_ATT($conn, $user_id, $_SESSION['school_id'], $_SESSION['active_sy_id'], $kra['tobj_id'], $kra['kra_id']);
