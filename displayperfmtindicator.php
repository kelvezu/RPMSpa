                ...
                <div class="modal-body">
                        ...
                        <div class="col-lg">
                            ...
                            <div class="col-lg">
                                ...
                                <input type="number" name="level_no" class="form-control">
                            </div>
                            </div>
                            <div class="row">
                            <div class="col-lg">
                            ...
                            <div class="col-lg">
                                ...
                                <textarea name="desc_name" id="desc" cols="5" rows="5" class="form-control" placeholder="Enter the indicator description..."></textarea>
                            </div>
                            </div>
                            <div class="m-2">
